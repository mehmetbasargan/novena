...
function register_novena_project()
{
    $labels = array(
        'name'               => __('Branşlar', 'novena'),
        'singular_name'      => __('branslar', 'novena'),
        ...
        'search_items'       => __('Branş Ara', 'novena'),
        'not_found'          => __('Branş Bulunamadı', 'novena'),
        'not_found_in_trash' => __('Çöpte Branş Bulunamadı', 'novena'),
        'parent_item_colon'  => __('Ana iş:', 'novena'),
        'menu_name'          => __('Branşlar', 'novena'),
    );
    ...
    register_post_type('branslar',  $args);
}
add_action('init', 'register_novena_project');
...
function register_taxonomy_filters()
{
    ...
    register_taxonomy('filters', array('branslar'), $args);
}
